...
<body>
  ...
  <main>
        <div class="container">
            <h1>Bienvenue sur le site de <?php echo $nom_du_resto ?></h1>
            <div>
                Audacieux, inédit et spectaculaire, le <strong class="majuscule"><?php  echo $nom_du_resto  ?></strong> est né le 12 Mai 2020.<br/><br/>
